...
def wiki_connect(search_term, section='summary', subsection = None):
    """
...
def members():
    request_data = request.json['search']
    wiki_text = wiki_connect(request_data)
    print(wiki_text)
    return jsonify(wiki_text=wiki_text)
...
#
# print(wiki_connect("Tesla, Inc", "summary" ))
